                            ...
                            <div class="main-search-input-wrap shadow_msiw">
                                <div class="main-search-input fl-wrap">
                                    <div class="main-search-input-item">
                                        <input type="text" wire:model="search" placeholder="What are you looking for?" value=""/>
                                    </div>
                                    {{-- <div class="main-search-input-item">
                                    ...
                                    <div class="main-search-input-item">
                                        <select data-placeholder="All Categories" wire:model="state" class="chosen-select">
